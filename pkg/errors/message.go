...
var MsgMap = map[ErrorType]string{
	...
	ErrorExistRoleUser:         "The role has been given to the customer and is not allowed to be deleted",
	ErrorNotExistRole:          "Role customer is disabled, please contact administrator",
